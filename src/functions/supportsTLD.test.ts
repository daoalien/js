...
describe('supportsTLD', () => {
  it('should return true for .celo tld', async () => {
    const result = await ensInstance.supportsTLD('celo')
  ...
  it('should return true for .celo name', async () => {
    const result = await ensInstance.supportsTLD('test123.celo')
    expect(result).toBeTruthy()
  })
